    ...
    >
        ...
        <section class="bg-neutral-50 border-b border-neutral-200 py-14">
            <div class="mx-auto max-w-3xl px-6">
                ...
                <h1 class="text-4xl font-bold tracking-tight text-neutral-950">Terms of Service</h1>
        ...
        <section class="py-14">
            <div class="mx-auto max-w-3xl px-6">
                ...
                <div class="space-y-12">
                    ...
                    <div>
                        <h2 class="text-xl font-semibold text-neutral-950 mb-3">4. Payment Terms</h2>
                        <div class="h-px bg-neutral-200 mb-5"></div>
                        <p class="text-neutral-700 leading-relaxed">
                            Subscription fees are billed in advance on a monthly or annual basis, depending on your chosen plan. All fees are non-refundable except as required by applicable law. We may change our pricing with at least 30 days' notice. Failure to pay may result in suspension or termination of your account. Payments are processed securely through Stripe.
                        </p>
                    </div>
                    ...
                    <div>
                        <h2 class="text-xl font-semibold text-neutral-950 mb-3">11. Dispute Resolution</h2>
                        <div class="h-px bg-neutral-200 mb-5"></div>
                        <p class="text-neutral-700 leading-relaxed">
                            Before initiating any formal dispute, you agree to contact us and attempt to resolve the matter informally. If a dispute cannot be resolved informally within 30 days, any controversy or claim arising out of or relating to these Terms shall be settled by binding arbitration administered in accordance with the rules of the American Arbitration Association. Class action lawsuits and class-wide arbitration are not permitted.
                        </p>
                    </div>

                    <div>
                        <h2 class="text-xl font-semibold text-neutral-950 mb-3">12. Contact Information</h2>
                        <div class="h-px bg-neutral-200 mb-5"></div>
                        <p class="text-neutral-700 leading-relaxed">
                            If you have any questions about these Terms, please contact us via our contact page or by emailing us directly. We will make every reasonable effort to respond promptly and resolve any concerns.
                        </p>
                    </div>
                ...
                <div class="mt-14 rounded-xl border border-neutral-200 bg-neutral-50 px-6 py-8 text-center">
                    ...
                    <p class="text-sm text-neutral-500 mb-5">Our team is happy to help clarify anything in these Terms.</p>
